...
class AnalysisPlugin extends FiberPlugin {
  ...
  during setup new Area {
    println(s"[${AnalysisPlugin.this.getDisplayName()}] setup start")
    println(s"[${AnalysisPlugin.this.getDisplayName()}] setup end")
  }

  during build new Area {
    println(s"[${AnalysisPlugin.this.getDisplayName()}] build start")
    ...
    println(s"[${AnalysisPlugin.this.getDisplayName()}] build end")
  }
}
