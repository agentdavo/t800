...
/** T9000 Hardware Instruction Grouper Plugin - The Heart of T9000 Performance
  *
  * This plugin implements the T9000's revolutionary hardware grouper that acts as a "hardware
  * optimizer" to achieve up to 200 MIPS (4 instructions/cycle).
  *
  * Key Features:
  ...
  *   - Pipeline stage allocation: * Stage 1: Fetch + two local variables * Stage 2: Two address
  *     calculations * Stage 3: Two non-local variable loads * Stage 4: ALU or FPU operation * Stage
  *     5: Conditional jump or write
  */
