...
class EventChannelPlugin extends FiberPlugin {
  ...
  during setup new Area {
    println(s"[${EventChannelPlugin.this.getDisplayName()}] setup start")
    ...
    println(s"[${EventChannelPlugin.this.getDisplayName()}] setup end")
  }
  ...
  during build new Area {
    println(s"[${EventChannelPlugin.this.getDisplayName()}] build start")
