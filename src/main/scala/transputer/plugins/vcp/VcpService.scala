 ...
 * 
 * Manages DS-Link virtual channels and packet routing per T9000 specification
 * Chapter 12. Provides high-level interface for virtual channel communication.
 */
trait VcpService {
...
/**
 * DS-Link Hardware Service
 * Low-level interface to physical DS-Link hardware
 */
trait DsLinkService {
